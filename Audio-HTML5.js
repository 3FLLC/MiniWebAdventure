...
var oggsnd      = "http://opengameart.org/sites/default/files/Battle%20dirty.ogg";      // OGG FILE
var oggsnd      = "http://opengameart.org/sites/default/files/Battle_0.ogg";    // OGG FILE
...
document.write('<table style="position:absolute;top:560px;left:220px;border-collapse:collapse; border-spacing: 0px; margin: '+centerply+'; padding: 0px; border: #'+bordcolor+' '+borderw+'px solid;"><tr><td style="vertical-align: middle; text-align: center; padding: 0px;">');
